...
- **[Database Setup](setup/database-setup.md)** - Complete database configuration and SQL setup
- **[Authentication Guide](setup/authentication-guide.md)** - Authentication & role-based access control
- **[Data Setup Guide](setup/DATA_SETUP_GUIDE.md)** - Data integration with Supabase
- **[Role Setup Guide](setup/ROLE_SETUP_GUIDE.md)** - Role-based access control configuration
- **[Test User Guide](setup/TEST_USER_GUIDE.md)** - Creating and managing test users
...
- **Authentication work**: Use [Authentication Guide](setup/authentication-guide.md)
...
- **Database changes**: Use [Database Setup](setup/database-setup.md)
