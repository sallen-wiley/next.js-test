    ...
    <>
      <Container fixed sx={{ pt: 3, pb: 3 }}>
        ...
        >
          ...
          >
            <Typography variant="h6">Invitations & Queue</Typography>
            <IconButton onClick={() => setRightPanelOpen(false)} size="small">
              <CloseIcon />
            </IconButton>
          </Box>
          <Box
          ...
          {/* Drawer Footer with Queue Controls */}
          <Box
            sx={{
              borderTop: 1,
              borderColor: "divider",
