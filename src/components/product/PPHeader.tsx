...
import { Box, Divider, Link, Typography, IconButton } from "@mui/material";
import MenuIcon from "@mui/icons-material/Menu";
import HeaderActions from "./HeaderActions";

function PrimaryLogo({ logoAffix }: { logoAffix?: string }) {
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <PrimaryLogo logoAffix={logoAffix} />
          <HeaderActions
