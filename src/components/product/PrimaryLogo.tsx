...
// Define tenant types
export type TenantType = "wiley" | "wiley2025" | "sage" | "ieee" | "default";
...
> = {
  ...
  wiley2025: {
    ...
    path: (
      <g>
        {/* Logo mark - theme-dependent color */}
        <g clipPath="url(#wiley2025-clip)">
          <use href="#wiley2025-B" className="wiley2025-logomark" />
          <use href="#wiley2025-C" className="wiley2025-logomark" />
          <use href="#wiley2025-B" className="wiley2025-logomark" />
          <use href="#wiley2025-C" className="wiley2025-logomark" />
          <use href="#wiley2025-B" className="wiley2025-logomark" />
          <use href="#wiley2025-C" className="wiley2025-logomark" />
        </g>
        {/* Wordmark - currentColor (theme-dependent) */}
        <path
          d="M73.528 32h.159l6.763-16.96c.637-1.6 1.273-2.4 1.91-2.8v-.16h-4.058v.16c.875.48 1.034 1.76.477 3.2l-4.137 10.48L68.913 12h-.159l-5.967 13.84-4.297-10.88c-.477-1.28-.398-2.24.477-2.72v-.16H53v.16c.636.32 1.114 1.04 1.671 2.4L61.752 32h.159l5.888-14.08L73.528 32zm43.919-9.76V16.8h5.729c2.625 0 3.58.4 4.535 1.76l.159-.08-.318-3.04H113.23v.16c.876.56 1.114 1.28 1.114 2.4v10.88c0 1.12-.238 1.92-1.114 2.4v.16h15.038l.557-3.28-.159-.08c-.955 1.28-2.148 2-4.694 2h-6.525V23.6h4.376c1.91 0 2.785.32 3.342 1.12h.159V21.2h-.159c-.477.8-1.432 1.12-3.342 1.12h-4.376v-.08zm19.175 9.04v.16h5.49v-.16c-.875-.56-1.193-1.36-1.193-2.72V24.8l4.853-6.96c.875-1.28 1.591-2.08 2.228-2.32v-.16h-4.296v.16c.795.48.875 1.52.079 2.72l-3.58 5.12-3.819-5.76c-.637-.88-.478-1.68.238-2.08v-.16h-6.047v.16c.716.32 1.194.72 1.91 1.84l5.331 7.68v3.52c.079 1.36-.239 2.16-1.194 2.72zm-26.574.16l.795-3.36-.159-.08c-.955 1.44-2.387 2.08-4.455 2.08h-6.206V18.24c0-1.36.318-2.16 1.273-2.72v-.16h-5.49v.16c.875.56 1.114 1.28 1.114 2.4V28.8c0 1.12-.239 1.92-1.114 2.4v.16h14.242v.08zm-24.267-2.72c0 1.28-.239 2.08-1.194 2.56v.16h5.49v-.16c-.875-.48-1.193-1.28-1.193-2.56V18.08c0-1.2.239-2 1.193-2.56v-.16h-5.41v.16c.875.56 1.193 1.36 1.193 2.56v10.64h-.079z"
          fill="currentColor"
          className="wiley2025-wordmark"
        />
        {/* Define clip path and reusable elements */}
        <defs>
          <clipPath id="wiley2025-clip">
            <path fill="#fff" d="M0 0h37v40H0z" />
          </clipPath>
          <path
            id="wiley2025-B"
            d="M35.142 19.673c-.061-5.852-1.177-12.928-6.658-16.109C23.459.645 13.992.713 8.841 3.37c-5.005 2.543-6.794 8.521-7.042 13.826-.255 5.855.005 13.043 4.327 17.407 2.97 2.964 7.409 3.786 11.445 3.924 3.061.063 6.288-.178 9.188-1.316 6.94-2.707 8.492-10.8 8.383-17.508v-.03h0zM21.354.151C26.847.68 32.276 3.774 34.71 8.836c2.27 4.786 2.724 10.771 1.924 15.995-1.14 7.366-5.272 12.763-12.676 14.535-4.528 1.03-9.911.881-14.176-1.009-6.505-2.884-9.54-9.308-9.726-16.23-.258-5.512.262-11.575 3.831-15.985C8.143.867 14.886-.495 21.325.148l.029.003z"
          />
          <path
            id="wiley2025-C"
            d="M23.848 31.165h.131l6.432-16.109c.628-1.55 1.203-2.313 1.779-2.653v-.158h-3.871v.158c.811.446.994 1.655.445 3.047l-3.948 9.934-5.362-13.192h-.129l-5.649 13.166-4.054-10.355c-.47-1.234-.339-2.154.418-2.6v-.158H4.394v.158c.602.315 1.045.971 1.595 2.312l6.642 16.45h.13l5.596-13.324 5.492 13.324h0z"
          />
        </defs>
      </g>
    ),
