...
import { forceLogoFillColor } from "./fillUtils";

// IEEE logo with #00629B color (preserved in both light and dark mode)
const ieeeLightPath = (
  <g>
...
export const ieeeLogo: LogoConfig = {
  viewBox: "0 0 390 120",
  width: 195 * 0.7,
  height: 60 * 0.7,
  path: ieeeLightPath,
  dark: forceLogoFillColor(ieeeLightPath, "#fff"),
};
